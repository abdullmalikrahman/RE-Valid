...
class Station(Base):
    ...
    wind_baseline_gwa: Mapped[float | None] = mapped_column(Numeric(5, 2))
    ghi_baseline_gsa: Mapped[float | None] = mapped_column(Numeric(5, 2))
    wind_baseline_nasa: Mapped[float | None] = mapped_column(Numeric(5, 2))
    ghi_baseline_nasa: Mapped[float | None] = mapped_column(Numeric(5, 2))
    aep: Mapped[int | None] = mapped_column(Integer)
    wind_aep: Mapped[int | None] = mapped_column(Integer)
    solar_aep: Mapped[int | None] = mapped_column(Integer)
    ...
    wind_rmse: Mapped[float | None] = mapped_column(Numeric(6, 3))
    wind_bias: Mapped[float | None] = mapped_column(Numeric(6, 2))
    wind_r2: Mapped[float | None] = mapped_column(Numeric(5, 3))
